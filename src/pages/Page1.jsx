...
function Page1() {
  ...
  return (
    <motion.div
      className="h-screen font-mono bg-[#0a0a0a] text-white flex flex-col justify-start md:flex-row pt-16 lg:pt-20"
      initial="hidden"
      animate="visible"
    >
      <div className="md:hidden flex border-b border-white/10 bg-[#0a0a0a] sticky top-16 z-40">
        <button
        ...
        <button
          ...
          className={`flex-1 px-4 py-3 text-sm font-medium transition-colors ${activeTab === 'studio'
              ? 'text-white border-b-2 border-blue-500'
              : 'text-gray-400 hover:text-white'
            }`}
        >
      ...
      <motion.div
        className={`${activeTab === 'sources' ? 'flex' : 'hidden'
          } md:flex w-full md:w-[27%] border-r border-white/10 flex-col overflow-hidden p-2 rounded-2xl h-full `}
      ...
      <motion.div
        className={`${activeTab === 'chat' ? 'flex' : 'hidden'
          } md:flex w-full md:w-[50%] border-r border-white/10 flex-col overflow-hidden p-2 rounded-lg`}
        variants={panelVariants}
      ...
      <motion.div
        className={`${activeTab === 'studio' ? 'flex' : 'hidden'
